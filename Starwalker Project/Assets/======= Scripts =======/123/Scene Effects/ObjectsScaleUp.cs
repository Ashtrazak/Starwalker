...
public class ObjectsScaleUp : MonoBehaviour
{
    ...
    void OnEnable()
    {
        GetComponent<ObjectsScaleDown>().enabled = false; // Отключаем скрипт противоположного действия
    ...
    void Update()
    {
        ...
        _transform.localScale = new Vector3(curentValue, curentValue, curentValue);
    }
}